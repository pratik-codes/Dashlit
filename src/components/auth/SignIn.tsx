    ...
    <div className="w-full">
      <form className="pt-6 pb-8 mb-4">
        ...
        <div className="mb-4">
          ...
          <input
            className="bg-gray-800 text-white border-gray-800 shadow appearance-none border w-full p-3  mb-3 rounded-lg focus:outline-none focus:shadow-outline"
            id="Email"
            type="text"
        ...
        <div className="mb-6">
          ...
          <input
            className="bg-metal text-white border-gray-800 shadow appearance-none border w-full p-3 mb-3 rounded-lg focus:outline-none focus:shadow-outline"
            id="password"
            type="password"
